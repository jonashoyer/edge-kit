...
export const useAnalytics = () => {
  ...
  return {
    capture<TEvent extends keyof AnalyticsEvents>(event: TEvent, properties: AnalyticsEvents[TEvent]) {
      posthog.capture(event as string, properties);
    },
    identify(newDistinctId?: string, userPropertiesToSet?: Properties, userPropertiesToSetOnce?: Properties) {
