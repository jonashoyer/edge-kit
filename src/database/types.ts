...
export type AnyMySqlDatabase = MySqlDatabase<MySqlQueryResultHKT, PreparedQueryHKTBase, any>;
...
export type DefaultSchema<
  Flavor extends SqlFlavorOptions,
  TMySqlSchema extends Record<TKeys, MySqlTableWithColumns<any>>,
  TPostgresSchema extends Record<TKeys, PgTableWithColumns<any>>,
  TSQLiteSchema extends Record<TKeys, SQLiteTableWithColumns<any>>,
